...
if __name__ == "__main__":
    if args.mode == 'train':
        ...
        normal_train, _ = get_sentence(args.train_data, args.test_data)
        transfer_train, _ = get_sentence(args.transfer_train_data, args.transfer_test_data)
        train_manager, test_manager, transfer_train_manager, transfer_test_manager, id2char, id2tag, transfer_id2tag = get_train_data()
        char2id, _, _, _, transfer_tag2id, _ = get_transform(normal_train + transfer_train,
                                               args.map_path,
                                               args.tag2label_path,
                                               args.transfer_tag2label_path)
